...
export const DMItem: React.FC<IDMItemProps> = ({ partner, me }) => {
  ...
  return (
    <>
      ...
      <div onClick={handleClick} className={classes.dialogContainer}>
        <Grid alignItems="center" container wrap="nowrap" className={classes.dialogWrapper}>
          <Grid item xs={1}>
            <Avatar
